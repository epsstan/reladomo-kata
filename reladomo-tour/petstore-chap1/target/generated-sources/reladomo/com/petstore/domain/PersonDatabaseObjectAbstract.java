...
public abstract class PersonDatabaseObjectAbstract extends MithraAbstractTransactionalDatabaseObject implements MithraTransactionalDatabaseObject, MithraObjectFactory
{
	...
	private static final String COL_LIST_WITHOUT_PK = "FIRST_NAME,LAST_NAME";
	private static final String COL_LIST_WITHOUT_PK_WITH_ALIAS = "t0.FIRST_NAME,t0.LAST_NAME";
	...
	{
		super("Person", "com.petstore.domain.PersonFinder",
			3, 3,
	...
	public List getSimulatedSequenceInitValues()
	{
		...
		initValues = new SimulatedSequenceInitValues("Person",
			10, 1, 1,
			"com.petstore.util.ObjectSequenceObjectFactory", false, primaryKeyAttributes[0], primaryKeyAttributes[0].getSourceAttributeType());
	...
	public String getColumnListWithPk(String databaseAlias)
	{
		...
		{
			return "t0.PERSON_ID,t0.FIRST_NAME,t0.LAST_NAME";
		}
