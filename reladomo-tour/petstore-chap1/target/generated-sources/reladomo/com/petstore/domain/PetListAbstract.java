...
public class PetListAbstract extends DelegatingList<Pet> implements MithraDatedTransactionalList<Pet>
{
	...
	*/
	...
	{
		zSetTimestamp(PetFinder.processingDateFrom(), newValue);
	}

	public void setProcessingDateTo(Timestamp newValue)
	{
		zSetTimestamp(PetFinder.processingDateTo(), newValue);
	}
