...
{
	private static final String IMPL_CLASS_NAME_WITH_SLASHES = "com/petstore/domain/PetType";
	private static final String BUSINESS_CLASS_NAME_WITH_DOTS = "com.petstore.domain.PetType";
	private static final FinderMethodMap finderMethodMap;
	private static boolean isFullCache;
	private static boolean isOffHeap;
	private static volatile MithraObjectPortal objectPortal = new UninitializedPortal("com.petstore.domain.PetType");
	...
	public static class PetTypeRelatedFinder<ParentOwnerType, ReturnType, ReturnListType extends List, OwnerType> extends AbstractRelatedFinder<PetType, ParentOwnerType, ReturnType, ReturnListType, OwnerType>
	{
		...
		{
			return "com.petstore.domain.PetTypeFinder";
		}
	...
	{
		objectPortal.destroy();
		objectPortal = new UninitializedPortal("com.petstore.domain.PetType");
		isFullCache = false;
		isOffHeap = false;
	}
