...
{
	private static final String IMPL_CLASS_NAME_WITH_SLASHES = "petstore/ch1/domain/Pet";
	private static final String BUSINESS_CLASS_NAME_WITH_DOTS = "petstore.ch1.domain.Pet";
	private static final FinderMethodMap finderMethodMap;
	private static boolean isFullCache;
	private static boolean isOffHeap;
	private static volatile MithraObjectPortal objectPortal = new UninitializedPortal("petstore.ch1.domain.Pet");
	...
	public static Pet findByPrimaryKey(String petName)
	{
		return finder.findByPrimaryKey(petName);
	}
	...
	public static class PetRelatedFinder<ParentOwnerType, ReturnType, ReturnListType extends List, OwnerType> extends AbstractRelatedFinder<Pet, ParentOwnerType, ReturnType, ReturnListType, OwnerType>
	{
		...
		{
			return "petstore.ch1.domain.PetFinder";
		}
		...
		public IntegerAttribute<ParentOwnerType> personId()
		{
			...
			if (result == null)
			{
				...
				result.zSetOwningReverseRelationship("petstore.ch1.domain", "Person", "pets");
	...
	implements ToOneFinder
	{
		...
		public Pet findByPrimaryKey(String petName)
		{
			Pet _result = null;
			Operation _op = null;
	...
	{
		objectPortal.destroy();
		objectPortal = new UninitializedPortal("petstore.ch1.domain.Pet");
		isFullCache = false;
		isOffHeap = false;
	}
