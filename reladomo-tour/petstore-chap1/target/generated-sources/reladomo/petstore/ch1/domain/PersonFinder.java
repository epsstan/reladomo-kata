...
{
	private static final String IMPL_CLASS_NAME_WITH_SLASHES = "petstore/ch1/domain/Person";
	private static final String BUSINESS_CLASS_NAME_WITH_DOTS = "petstore.ch1.domain.Person";
	private static final FinderMethodMap finderMethodMap;
	private static boolean isFullCache;
	private static boolean isOffHeap;
	private static volatile MithraObjectPortal objectPortal = new UninitializedPortal("petstore.ch1.domain.Person");
	...
	public static class PersonRelatedFinder<ParentOwnerType, ReturnType, ReturnListType extends List, OwnerType> extends AbstractRelatedFinder<Person, ParentOwnerType, ReturnType, ReturnListType, OwnerType>
	{
		...
		{
			return "petstore.ch1.domain.PersonFinder";
		}
	...
	{
		objectPortal.destroy();
		objectPortal = new UninitializedPortal("petstore.ch1.domain.Person");
		isFullCache = false;
		isOffHeap = false;
	}
